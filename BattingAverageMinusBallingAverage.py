...
batting_average_mixed_index = 1
bowling_average_mixed_index = 2
...
for value in range(1,505):
    ...
    global team1_average
    global team2_average
    ...
    for line in reader2:
        ...
        if line[team_name_mixed_index] == team1_name:
            flag += 1
            team1_average = float(line[batting_average_mixed_index]) - float(line[bowling_average_mixed_index])

        if line[team_name_mixed_index] == team2_name:
            flag += 1
            team2_average = float(line[batting_average_mixed_index]) - float(line[bowling_average_mixed_index])

        if flag == 3:
            break

    print(team1_average, team2_average)
    print(winner)
    if(winner == 'tie'):
        tie = tie + 1
...
title('Effect of Batting Average Minus Bowling Average', bbox={'facecolor':'0.8', 'pad':5})
