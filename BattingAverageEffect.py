...
for value in range(1,505):
    ...
    for line in reader2:
        ...
        if line[team_name_mixed_index] == team1_name:
            flag += 1
            print(line[average_mixed_index] + '______________')
            team1_average = float(line[average_mixed_index])

        if line[team_name_mixed_index] == team2_name:
            flag += 1
            print(line[average_mixed_index] + '______________')
            team2_average = float(line[average_mixed_index])
...
title('Effect of Batting Average', bbox={'facecolor':'0.8', 'pad':5})
